...
#define SCALE_FACTOR 20  // scale factor 20 is fine maybe default
...
#define FETCH_OPCODE() (cpu.memory[cpu.pc] << 8 | cpu.memory[cpu.pc + 1]) 
...
typedef struct chip8_cpu {
    ...
    uint8_t sound_timer;          // timer reigster intended for sound effects, nonzero value
                                  // makes a beeping sound //TODO: make beep
